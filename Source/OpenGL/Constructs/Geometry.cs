...
namespace OpenGL
{
    ...
    public class Geometry
    {
        ...
        public static VAO CreateQuad(Material program, Vector2 location, Vector2 size)
        {
        ...
        /// <returns>The VAO object representing this quad.</returns>
        public static VAO CreateQuad(Material program, Vector2 location, Vector2 size, Vector2 uvloc, Vector2 uvsize)
        {
            Vector3[] vertices = new Vector3[] { new Vector3(location.X, location.Y, 0), new Vector3(location.X + size.X, location.Y, 0), 
                new Vector3(location.X + size.X, location.Y + size.Y, 0), new Vector3(location.X, location.Y + size.Y, 0) };
        ...
        /// <param name="size">The size of the VAO (assigned to the vertices).</param>
        /// <returns>The VAO object representing this quad.</returns>
        public static VAO CreateQuadWithNormals(Material program, Vector2 location, Vector2 size)
        {
        ...
        /// <returns></returns>
        public static VAO CreateCube(Material program, Vector3 min, Vector3 max)
        {
        ...
        /// <param name="max">The 3 maximum values of the cube (top right front corner).</param>
        /// <returns></returns>
        public static VAO CreateCubeWithNormals(Material program, Vector3 min, Vector3 max)
        {
            Vector3[] vertex = new Vector3[] {
                new Vector3(min.X, min.Y, max.Z),
                new Vector3(max.X, min.Y, max.Z),
